...
const services = [
  {
    ...
    title: "一對一健身",
    description:
      "依據你的目標與體能狀況，量身定制專屬訓練計畫。涵蓋重量訓練、健力週期化訓練，搭配矯正性運動與運動按摩，全方位提升你的表現。",
    features: ["客製化訓練計畫", "健身動作教學", "矯正性運動", "運動按摩放鬆"],
  },
  {
    icon: Heart,
    title: "孕婦健身",
    description:
      "MedEx 懷孕及產後訓練專家認證（PPES），烏烏醫師孕產肌力培訓。安全專業地陪伴準媽媽維持體能、減緩不適，產後順利恢復。",
  ...
  },
  {
    ...
    title: "團體課",
    description:
      "小班制互動教學，在團體的氛圍中一起突破極限。結合有氧與肌力的全方位課程。",
