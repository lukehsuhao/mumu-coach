...
const services = [
  {
    ...
    title: "一對一健身",
    description:
      "依據你的目標與體能狀況，量身定制專屬訓練計畫。從增肌減脂到體態雕塑，一對一指導讓每一步都精準到位。",
    features: ["客製化訓練計畫", "飲食建議", "姿勢矯正", "定期體態追蹤"],
  },
  {
    icon: Heart,
    title: "孕婦健身",
    description:
      "安全溫和的孕期運動指導，幫助準媽媽維持體能、減緩不適、為生產做好準備。專業且貼心的全程陪伴。",
    features: ["孕期安全運動", "核心穩定訓練", "骨盆底肌強化", "產後恢復指導"],
  },
  {
    icon: Users,
    title: "團體課",
